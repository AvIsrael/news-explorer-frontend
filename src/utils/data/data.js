...
const cardsData = [{
  ...
  text: 'Ever since I read Richard Louv`s influential book, "Last Child in the Woods," the idea of having '
      + 'a special "sit spot" has stuck with me. This advice, which Louv attributes to nature educator Jon Young, '
      + 'is for both adults and children to find a spot in nature – it could be anywhere, from an urban backyard to '
      + 'a nearby forest – and to spend time in it, sitting quietly.',
  ...
  text: '“The linking together of the Cascade and Death Canyon trails, at their heads, took place on October 1, '
        + '1933, and marked the first step in the realization of a plan whereby the hiker will be enabled to visit '
        + 'that most fascinating region…',
...
const savedCards = [{
  keyword: 'Nature', ...cardsData[0],
}, {
  keyword: 'Nature', ...cardsData[1],
}, {
  id: 4,
  keyword: 'Yellowstone',
  title: 'Nostalgic Photos of Tourists in U.S. National Parks',
  text: 'Uri Løvevild Golman and Helle Løvevild Golman are National Geographic Explorers and conservation '
        + 'photographers who just completed a project and book they call their love letter to nature. "Project WILD" '
        + 'features images and videos from their 25 expeditions on all seven continents over five years.',
  date: 'October 19, 2020',
  source: 'National Geographic',
  link: 'https://www.nationalgeographic.com/travel/article/sightseer-american-tourists-in-national-parks',
  image: card04,
}, {
  keyword: 'Parks', ...cardsData[2],
}, {
  id: 5,
  keyword: 'Photography',
  title: "Scientists Don't Know Why Polaris Is So Weird",
  text: 'Humans have long relied on the starry sky to push into new frontiers, sail to the very edge of the world '
        + 'and find their way back home again. Even animals look to the stars to guide them.',
  date: 'March 16, 2020',
  source: 'Treehugger',
